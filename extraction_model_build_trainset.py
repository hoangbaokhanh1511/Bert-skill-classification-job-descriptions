...
chunks1 = pickle.load( open(os.path.join(DATA_DIR, 'chunks_1.pickle'), "rb" ) )
chunks2 = pickle.load( open(os.path.join(DATA_DIR, 'chunks_2.pickle'), "rb" ) )
chunks3 = pickle.load( open(os.path.join(DATA_DIR, 'chunks_3.pickle'), "rb" ) )
chunks4 = pickle.load( open(os.path.join(DATA_DIR, 'chunks_4.pickle'), "rb" ) )
